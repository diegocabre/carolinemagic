...
export const WHATSAPP_MESSAGES = {
  ...
  academia: (nombrePrograma: string) =>
    `Hola, quiero información para inscribirme en: ${nombrePrograma}`,
  ritual: (nombreRitual: string) =>
    `Hola, quiero solicitar un ritual de: ${nombreRitual}`,
